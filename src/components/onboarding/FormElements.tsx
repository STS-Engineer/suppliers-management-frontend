...
export const FormInput: React.FC<FormInputProps> = ({
  ...
  helperText, min, max, step, maxLength, inputMode, suffix,
}) => {
  return (
    <div className="form-group">
      ...
      <div className="relative">
        <input
          ...
          min={min} max={max} step={step} maxLength={maxLength} inputMode={inputMode}
...
export const CreatableMultiSelect: React.FC<CreatableMultiSelectProps> = ({
  ...
  required = false, helperText, error, disabled = false,
}) => {
      ...
      <div className="relative">
        ...
        >
          <input
            ...
            className="flex-1 border-0 bg-transparent text-sm text-slate-900 placeholder-slate-400 outline-none disabled:cursor-not-allowed"
          />
